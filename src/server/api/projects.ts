...
const EXCLUDED_DIRS = new Set([
  ...
  '.vscode',
  '.cursor',
  // System/infra dirs (not projects)
  'agents',
  'app',
  'aws-cli',
  'backups',
  'bin',
  'catvton-lambda-sessions',
  'ckreynolds-migration',
  'claude-configs',
  'closet-manager',
  'Competitions',
  'config',
  ...
  'shared-media-server',
  'shell-snapshots',
  'spec-framework-architecture-template',
  'sprints',
  'staging',
  'strudel-package',
  'SuperCollider',
